...
def catalog(config, modules):
    ...
    for module in modules:
        ...
        if extra_targets:
            from thematic_interpretation import SYSTEM as frequency_system, TABLE_GUIDANCE, SHARED_GUIDANCE
            ...
            for target in extra_targets:
                ...
                templates.append({'key':target+' / frequency_interpretation_shared', 'system':frequency_system+SHARED_GUIDANCE,
                                  'user':'Falls auch die Tabelle zu groß ist: identische Feldwerte einmal mit ihrem vollständigen Feldpfad angeben. Sie gelten ausdrücklich für jede Themenzeile; alle übrigen Werte bleiben in der Tabelle.', 'placeholders':[]})
