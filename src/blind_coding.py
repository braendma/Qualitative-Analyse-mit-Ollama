...
def main(argv=None):
    ...
    raw_log_path = run_artifact_path("blind_coding_raw.jsonl") if raw_enabled else None
    LOGGER.info(
        "LLM-Raw-Audit: %s%s",
    ...
    markdown, output = blind_code_segments(
        ...
        checkpoint_path=(run_artifact_path(args.checkpoint or "blind_coding_checkpoint.json")
