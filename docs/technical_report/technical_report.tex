...
\usepackage{xurl}
\usepackage[hidelinks,pdftitle={Qualitative Analyse mit Ollama: Technischer Kurzbericht},pdfauthor={Marcus Brändle und OpenAI Codex (KI-Mitautor)}]{hyperref}
...
\begin{document}
\begin{center}
{\LARGE\bfseries Qualitative Analyse mit Ollama\par}
\vspace{4pt}
{\large Ein modularer Workflow für kodierte Textdaten\par}
\vspace{7pt}
...
\item \href{https://github.com/braendma/Qualitative-Analyse-mit-Ollama}{Repository und Quellcode}
\item \href{https://github.com/braendma/Qualitative-Analyse-mit-Ollama/releases/tag/v0.5.0-beta.1}{Version 0.5.0-beta.1 mit Windows- und macOS-Python-Downloads}
\item \href{https://github.com/braendma/Qualitative-Analyse-mit-Ollama/blob/main/docs/HANDBUCH.md}{Handbuch mit Bildern, Beispielen und ausführlicher methodischer Einordnung}
\end{itemize}
...
\hangindent=1.5em\hangafter=1 Maxwell, J. A. (2010). Using numbers in qualitative research. \textit{Qualitative Inquiry, 16}(6), 475–482. doi:10.1177/1077800410364740\par

\hangindent=1.5em\hangafter=1 Sandelowski, M. (2001). Real qualitative researchers do not count: The use of numbers in qualitative research. \textit{Research in Nursing \& Health, 24}(3), 230–240. doi:10.1002/nur.1025\par
\end{document}
