...
\usepackage[colorlinks=true,allcolors=linkblue,pdftitle={Qualitative Analyse mit Ollama: Technischer Kurzbericht},pdfauthor={Marcus Brändle und OpenAI Codex (KI-Mitautor)}]{hyperref}
